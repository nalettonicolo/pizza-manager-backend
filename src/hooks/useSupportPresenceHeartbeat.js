...
function labelFromPath(pathname) {
  ...
  if (p.startsWith("/operative/rider/1") || p.startsWith("/operative/pony/1")) return "Pony 1"
  if (p.startsWith("/operative/rider/2") || p.startsWith("/operative/pony/2")) return "Pony 2"
  if (p.startsWith("/operative/rider") || p.startsWith("/operative/pony")) return "Pony"
