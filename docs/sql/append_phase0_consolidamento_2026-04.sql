-- =============================================================================
-- CONSOLIDAMENTO FASE 0 — da accodare a schema_completo_pizzamanager.sql
-- Merge: hardening create_order (sql_upgrade) + web_cliente_user_id (schema)
-- + delivery_mark_consegnato + vincolo/view prodotto_ingrediente (posizione_cottura)
-- =============================================================================
