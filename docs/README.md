# Documentazione PizzaManager (`docs/`)

Indice degli artifact in questa cartella. I comandi operative di deploy vivono nella root (`DEPLOY_COMANDI.md`, `DEPLOY.md` dove presenti).

---

## Sintesi prodotto e architettura
...
| Documento | Contenuto |
|-----------|-----------|
| [QA_CHECKLIST_SMOKE.md](./QA_CHECKLIST_SMOKE.md) | Smoke regressione SPA + checklist operativa multi-reparto |
| [SICUREZZA_HARDENING.md](./SICUREZZA_HARDENING.md) | Blindatura e linee guida |

---

## Pianificazione self-host / stacco DB (non obbligatoria per uso quotidiano Supabase)
...
| Documento | Contenuto |
|-----------|-----------|
| [ANALISI_GESTIONALE_COMPLETO_E_QUESTIONARIO_SVILUPPO.md](./ANALISI_GESTIONALE_COMPLETO_E_QUESTIONARIO_SVILUPPO.md) | Perimetro gestionale |
| [ANALISI_PERIMETRO_FISCALE_E_QUESTIONARIO_SVILUPPO.md](./ANALISI_PERIMETRO_FISCALE_E_QUESTIONARIO_SVILUPPO.md) | Perimetro normativo IT |
